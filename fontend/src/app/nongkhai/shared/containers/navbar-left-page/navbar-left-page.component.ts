...
import { BRAND, PRICE_START, PRICE_END, YEAR, PRICE } from '../../constants/data.constant';
import { brandAttribute, modelsAttribute } from '../../../../../../../src/models/db';
import { BrandService } from '../../services/brand.service';
import { HttpService } from '../../services/http.service';
import { Router, ActivatedRoute, NavigationEnd } from '@angular/router';
import { LINK_NONGKHAI, BRANCH } from './../../constants/data.constant';
...
export class NavbarLeftPageComponent implements OnInit {
  ...
  routeToCarPage(params) {
    this.router.navigate([`${LINK_NONGKHAI}/car/list`], { queryParams: params });
  }
